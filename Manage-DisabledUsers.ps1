...
.DESCRIPTION
    ...
    de usuários desativados no Active Directory da Empresa XXX.
	...
	$EmailBody += @"
        ...
        <div class="footer">
            ...
            <p style="font-size: 10px; color: #999;">
                Script versão 3.3 - Sistema de Auditoria Empresa XXX<br>
...
function Start-DisabledUsersManagement
{
	...
	Write-Host "║                    Empresa XXX - v3.3                          ║" -ForegroundColor Cyan
	...
	Write-Host "Para suporte técnico, contate: xxx@cominio.com.br" -ForegroundColor Cyan
}
